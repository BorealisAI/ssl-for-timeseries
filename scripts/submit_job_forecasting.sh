...
do
    ...
    # dataset can be `ETTh1`, `ETTh2`, and `ETTm1`, `electricity`
    # run_name is either `forecast_multivar` or `forecast_univar` depending on the number of forecasting variables
    # loader is either `forecast_csv` (use for multivariate) or `forecast_csv_univar` (use for univariate)
